...
[![x-cmd/install — rustnet Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/rustnet.svg?lang=zh)](https://x-cmd.com/install/rustnet)
...
合计: **195,231** 行代码（覆盖前 5 种语言、共 **196** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| CHeader | 132,354 | 27 | 17,612 | 5 |
| Rust | 61,397 | 3,643 | 7,676 | 177 |
| Sh | 425 | 143 | 102 | 7 |
| Toml | 373 | 58 | 50 | 6 |
| Python | 336 | 20 | 68 | 1 |
...
- **官网**: <https://github.com/domcyrus/rustnet#quick-start>
- **许可证**: Apache-2.0
...
- **Star**: 5,053 · **Fork**: 236 · **开放 issue**: 102 · **贡献者**: 10

## 累计统计

- **发布数**: 25 · **已合并 PR**: 462 · **开放 PR**: 10 · **已关闭 issue**: 84 · **开放 issue**: 18 · **提交数**: 747

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 29 | 1 | 2 | 0 | 30 |
| last60d | 2026-07-27 | 1 | 114 | 2 | 5 | 0 | 111 |
| 90d | 2026-06-27 | 2 | 166 | 3 | 6 | 3 | 166 |
| last180d | 2026-03-29 | 5 | 295 | 10 | 49 | 18 | 298 |
| 360d | 2025-09-30 | 15 | 456 | 10 | 70 | 18 | 524 |
| last720d | 2024-10-05 | 25 | 462 | 10 | 84 | 18 | 747 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/rustnet.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:07:27Z._
